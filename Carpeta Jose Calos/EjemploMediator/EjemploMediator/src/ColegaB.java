// Esta es una clase llamada "ColegaB" que implementa la interfaz "Colega".
public class ColegaB implements Colega {
    ...
    public void recibirMensaje(String mensaje) {
        ...
        System.out.println("Colega B recibe el mensaje: " + mensaje);
    }
}
